  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">SMK Cendikia</div>
      </a>
      ...
      <li class="nav-item">
        <a class="nav-link" href="/pembagiankelas">
          <i class="fas fa-fw fa-clone"></i>
          <span>Pembagian Kelas Siswa</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/jadwal">
          <i class="fas fa-fw fa-calendar-check"></i>
          <span>Jadwal Belajar Mengajar</span>
        </a>
      </li>
    </ul>
    <!-- Sidebar -->
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <p>Apakah anda yakin akan melakukan logout?</p>
                </div>
        ...
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>&copy; <script> document.write(new Date().getFullYear()); </script>
              <b>Aplikasi Jadwal Belajar Mengajar - SMK Cendikia</b>
            </span>
          </div>
        </div>
      </footer>
