...
@section('content')
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Tambah Data Pembagian Kelas Siswa</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="/">Home</a></li>
              <li class="breadcrumb-item"><a href="/pembagiankelas">Data Pembagian Kelas Siswa</a></li>
              <li class="breadcrumb-item active" aria-current="page">Tambah Data Pembagian Kelas Siswa</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Tambah Data Pembagian Kelas Siswa</h6>
                </div>
                <div class="card-body">
                  <form>
                    <div class="row">
