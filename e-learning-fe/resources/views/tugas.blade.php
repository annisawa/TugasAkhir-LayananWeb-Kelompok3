          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3><small>Tugas Pembelajaran</small></h3>
              </div>

            <div class="clearfix"></div>
            <div class="form-group">
                <button type="button" class="btn btn-primary mb-5" data-toggle="modal" data-target="#modalmateri"><i class="fa fa-plus-circle"></i> Buat Tugas
                </button>
            ...
            <div class="modal fade" id="modalmateri" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true" style="overflow: auto !important;">
              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <a href="add.html"><h2><i class="fa fa-bullhorn"></i> <small>Tugas Pembelaaran</small></h2></a>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                      <div class="row">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                      <thead>
                        <tr>
                          <td align="center">Judul Tugas</td>
