      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="/admin-dashboard" class="site_title"><img src="{{asset('assets/images/logo-smk.png')}}" width="50">&nbsp;&nbsp;<span>E-Learning</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  ...
                  <li><a href="/admin-jadwal"><i class="fa fa-list"></i>Jadwal Kelas</a></li>
        ...
        <footer>
          <div class="pull-right">
            E-Learning SMK Cendikia - <b>Tugas Layanan Web</b>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
