...
<body>
  ...
  <div class="topnav" id="myTopnav">
    ...
    <div class="nav-menu">
      ...
      <a style="color: #2155cd">Register</a>
      <a href="/peserta-login">Login</a>
    </div>
  </div>
  ...
  <div class="section-jual">
    ...
    <div class="progress-jual">
      <img src="asset2/img/persyaratan.png" class="img-vector2">
    </div>
    ...
    <div class="form-login">
      ...
      <br>
      <div style="text-align: center">
        <a class="btn-jual" href="/peserta-login">Login</a>
      </div>
    </div>
  </div>
